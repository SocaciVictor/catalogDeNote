...
<div class="w-screen h-screen flex justify-center items-center
    ...
    <div class="p-10 bg-white rounded-xl drop-shadow-lg space-y-5" >
        <form  action="/register" method="POST">
            ...
            <div class="flex flex-col space-y-2">
                <label class="text-sm font-light" for="role">Role</label>
                <select class="w-96 px-3 py-2 rounded-md border border-slate-400" name="role" id="role" required>
                    <!-- JSTL: Iterează prin lista de roluri -->
