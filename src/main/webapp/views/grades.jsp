...
<div class="container mx-auto px-4">
    ...
    <div class="mb-4">
        <a href="grades?sort=date" class="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded mr-2">Sort by Date</a>
        <a href="grades?sort=student" class="bg-green-500 hover:bg-green-700 text-white py-2 px-4 rounded mr-2">Sort by Student Name</a>
        <a href="grades?sort=subject" class="bg-red-500 hover:bg-red-700 text-white py-2 px-4 rounded">Sort by Subject Name</a>
    </div>
    ...
    <div class="flex flex-col">
        <c:forEach items="${grades}" var="grade">
            <div class="bg-white p-4 shadow-md rounded-lg mb-4 flex justify-between items-center">
                <!-- Grade Information -->
                <span class="text-gray-800 text-lg">Grade: ${grade.gradeValue}  Subject Name: ${grade.studentSubject.subject.subjectName}  Student Name: ${grade.studentSubject.student.name} Date: ${grade.addedDate}</span>
